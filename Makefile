...
build:
	$(docker) build -t localhost:32000/vandorjw/django-assessment:local .
...
run:
	...
	-p 5678:5000 \
	--env-file ./.env \
	localhost:32000/vandorjw/django-assessment:local
...
push:
	microk8s.ctr image push vandorjw/django-assessment
